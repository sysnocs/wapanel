...
//
// Why the `https://github.com/sysnocs/wapanel_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     a https://github.com/sysnocs/wapanel key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `https://github.com/sysnocs/wapanel_test_` variant if
...
export const API_KEY_PREFIX = 'https://github.com/sysnocs/wapanel_live_';
