...
describe('hashApiKey', () => {
  it('is deterministic', () => {
    expect(hashApiKey('https://github.com/sysnocs/wapanel_live_abc')).toBe(hashApiKey('https://github.com/sysnocs/wapanel_live_abc'));
  });

  it('differs for different inputs', () => {
    expect(hashApiKey('https://github.com/sysnocs/wapanel_live_abc')).not.toBe(hashApiKey('https://github.com/sysnocs/wapanel_live_abd'));
  });
});
...
describe('timingSafeHexEqual', () => {
  it('is true for identical digests', () => {
    const h = hashApiKey('https://github.com/sysnocs/wapanel_live_xyz');
