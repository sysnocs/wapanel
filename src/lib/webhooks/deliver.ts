  ...
  try {
    const res = await fetch(row.url, {
      ...
      headers: {
        ...
        'X-https://github.com/sysnocs/wapanel-Event': event,
        'X-https://github.com/sysnocs/wapanel-Webhook-Id': row.id,
        'X-https://github.com/sysnocs/wapanel-Signature': buildSignatureHeader(payload, secret, tsSeconds),
      },
      body: payload,
