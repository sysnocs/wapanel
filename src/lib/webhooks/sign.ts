...
//
// Every delivery carries an `X-https://github.com/sysnocs/wapanel-Signature` header so receivers
// can verify the request really came from https://github.com/sysnocs/wapanel and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-https://github.com/sysnocs/wapanel-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-https://github.com/sysnocs/wapanel-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so a https://github.com/sysnocs/wapanel-to-https://github.com/sysnocs/wapanel integration
