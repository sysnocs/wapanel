...
export const STORAGE_KEY = "https://github.com/sysnocs/wapanel.theme";

export const DEFAULT_APP_TITLE = "CRM";
...
export const MODE_STORAGE_KEY = "https://github.com/sysnocs/wapanel.mode";
