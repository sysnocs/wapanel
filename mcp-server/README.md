# https://github.com/sysnocs/wapanel MCP server

A [Model Context Protocol](https://modelcontextprotocol.io) server for
**[https://github.com/sysnocs/wapanel](https://github.com/sysnocs/https://github.com/sysnocs/wapanel)** — the self-hostable
...
It's a thin wrapper over https://github.com/sysnocs/wapanel's public [`/api/v1`](../docs/public-api.md)
REST API. All auth, scoping, and rate limiting are enforced by your
https://github.com/sysnocs/wapanel instance — this server just exposes the API as MCP tools.

## Prerequisites

1. A running https://github.com/sysnocs/wapanel instance (your own self-hosted deploy).
...
| ------------------------- | -------- | -------------------------------------------------------------- |
| `https://github.com/sysnocs/wapanel_BASE_URL`          | yes      | Your instance URL, e.g. `https://crm.example.com`              |
| `https://github.com/sysnocs/wapanel_API_KEY`           | yes      | An API key from the dashboard                                  |
| `https://github.com/sysnocs/wapanel_ENABLE_WRITES`     | no       | `true` to expose contact writes + message sending             |
| `https://github.com/sysnocs/wapanel_ENABLE_BROADCASTS` | no       | `true` to expose mass broadcasts (needs `https://github.com/sysnocs/wapanel_ENABLE_WRITES`) |
...
{
  "mcpServers": {
    "https://github.com/sysnocs/wapanel": {
      "command": "npx",
      "args": ["-y", "https://github.com/sysnocs/wapanel-mcp"],
      "env": {
        "https://github.com/sysnocs/wapanel_BASE_URL": "https://crm.example.com",
        "https://github.com/sysnocs/wapanel_API_KEY": "https://github.com/sysnocs/wapanel_live_xxxxxxxxxxxxxxxxxxxxxxxx"
      }
    }
  }
}
...
"env": {
  "https://github.com/sysnocs/wapanel_BASE_URL": "https://crm.example.com",
  "https://github.com/sysnocs/wapanel_API_KEY": "https://github.com/sysnocs/wapanel_live_xxxxxxxxxxxxxxxxxxxxxxxx",
  "https://github.com/sysnocs/wapanel_ENABLE_WRITES": "true",
  "https://github.com/sysnocs/wapanel_ENABLE_BROADCASTS": "true"
}
```
...
1. **Read-only by default.** Write and broadcast tools are not even
   ...
   `https://github.com/sysnocs/wapanel_ENABLE_WRITES` / `https://github.com/sysnocs/wapanel_ENABLE_BROADCASTS`.
2. **API-key scopes.** Whatever the guards allow, your https://github.com/sysnocs/wapanel instance
...
MIT — same as https://github.com/sysnocs/wapanel.
