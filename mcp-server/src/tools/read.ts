...
export function registerReadTools(server: McpServer, client: https://github.com/sysnocs/wapanelClient): void {
  server.registerTool(
    'whoami',
    {
      title: 'Who am I',
      description:
        'Verify the API key and show which https://github.com/sysnocs/wapanel account it is bound to and what scopes it carries. Call this first to discover what actions are possible.',
      inputSchema: {},
