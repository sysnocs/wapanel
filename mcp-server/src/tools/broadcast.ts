...
//
// Registered only when BOTH https://github.com/sysnocs/wapanel_ENABLE_WRITES and
// https://github.com/sysnocs/wapanel_ENABLE_BROADCASTS are set. A single call can message up to
...
import type { https://github.com/sysnocs/wapanelClient } from '../client.js';
import { errorResult, handle, jsonResult } from './shared.js';

export function registerBroadcastTools(server: McpServer, client: https://github.com/sysnocs/wapanelClient): void {
  server.registerTool(
    'send_broadcast',
    {
