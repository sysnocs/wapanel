// ============================================================
// Write tools — registered only when https://github.com/sysnocs/wapanel_ENABLE_WRITES is set.
//
...
export function registerWriteTools(server: McpServer, client: https://github.com/sysnocs/wapanelClient): void {
  server.registerTool(
    'send_message',
    {
