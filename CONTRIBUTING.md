...
```bash
# 1. Fork on GitHub: https://github.com/sysnocs/https://github.com/sysnocs/wapanel → Fork
# 2. Clone your fork
...
```bash
git remote add upstream https://github.com/sysnocs/https://github.com/sysnocs/wapanel.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/sysnocs/https://github.com/sysnocs/wapanel/issues/new?template=bug_report.yml)
...
- Rebrand. The "CRM Template for WhatsApp" name, favicon, and
  `https://github.com/sysnocs/wapanel.tech` URL belong to the upstream project; please swap them
