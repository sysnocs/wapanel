...
--     (`https://github.com/sysnocs/wapanel_live_a1b2c3d4`) so the dashboard can show "which key
...
CREATE TABLE IF NOT EXISTS api_keys (
  ...
  name         text NOT NULL,
  key_prefix   text NOT NULL,             -- display only, e.g. "https://github.com/sysnocs/wapanel_live_a1b2c3d4"
