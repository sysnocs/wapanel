...
The public API lets you drive your https://github.com/sysnocs/wapanel instance from your own
...
```
Authorization: Bearer https://github.com/sysnocs/wapanel_live_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
```
...
3. Copy the key. **The full key is shown exactly once.** https://github.com/sysnocs/wapanel
...
curl https://your-crm.example.com/api/v1/me \
  -H "Authorization: Bearer https://github.com/sysnocs/wapanel_live_xxx"
```
...
Rather than polling, register an endpoint and https://github.com/sysnocs/wapanel will POST to it when
...
- `POST /api/v1/webhooks` — register `{ "url": "https://…", "events": ["message.received"] }`. `url` must be `https://`. **The response includes `secret` exactly once** — store it to verify signatures; https://github.com/sysnocs/wapanel keeps only an encrypted copy.
...
curl -X POST https://your-crm.example.com/api/v1/webhooks \
  -H "Authorization: Bearer https://github.com/sysnocs/wapanel_live_xxx" \
  -H "Content-Type: application/json" \
  -d '{ "url": "https://example.com/hooks/https://github.com/sysnocs/wapanel", "events": ["message.received"] }'
...
Headers: `X-https://github.com/sysnocs/wapanel-Event`, `X-https://github.com/sysnocs/wapanel-Webhook-Id`, and `X-https://github.com/sysnocs/wapanel-Signature`.

### Verifying the signature

`X-https://github.com/sysnocs/wapanel-Signature: t=<unix_seconds>,v1=<hex>` where `v1 =
...
covers messages https://github.com/sysnocs/wapanel stores (inbox + API sends), not broadcast-only
...
[#245](https://github.com/sysnocs/https://github.com/sysnocs/wapanel/issues/245). Future ideas
