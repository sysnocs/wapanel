...
https://github.com/sysnocs/wapanel ships a [Model Context Protocol](https://modelcontextprotocol.io)
...
[`https://github.com/sysnocs/wapanel-mcp`](https://www.npmjs.com/package/https://github.com/sysnocs/wapanel-mcp). Under the hood
...
data or send messages, add `"https://github.com/sysnocs/wapanel_ENABLE_WRITES": "true"` (and
`"https://github.com/sysnocs/wapanel_ENABLE_BROADCASTS": "true"` for mass sends) to `env`.
